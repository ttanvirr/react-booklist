...
- open chrome web store in browser
- search for 'React Developer Tools'
- install
- now we will see a 'Component' tab along with 'Console', etc.

#### First Project - Book List
...
- value inside must be an expression (return value),
  can't be a statement (e.g., let x=6)
  - google for different between expression and statement
...
- toggle line comment Edit/Toggle Line Comment (Ctrl+/)
...
#### Mind Grenade #1 (Anonymous Function)
...
#### Mind Grenade #2 (Component Feature)

- remove EventsExamples
- components are independent by default
- element selection like in Vanilla JS (...by query selectors) not needed.
...
- remove button
- react data flow - can only pass props down (e.g,. booklist -> book)
- alternatives Context API, redux, other state libraries (coming later)
